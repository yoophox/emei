...
const (
  ...
  // Header.Bits
  HEADER_FLAG_QR = 1 << 15 // query/response (response=1)
  HEADER_FLAG_AA = 1 << 10 // authoritative
  HEADER_FLAG_TC = 1 << 9  // truncated
  HEADER_FLAG_RD = 1 << 8  // recursion desired
  HEADER_FLAG_RA = 1 << 7  // recursion available
  HEADER_FLAG_Z  = 1 << 6  // Z
  HEADER_FLAG_AD = 1 << 5  // authenticated data
  HEADER_FLAG_CD = 1 << 4  // checking disabled
)
